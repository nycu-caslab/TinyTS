...
#include "arm_math_deprecated.h"
// #include "arm_math_memory.h"

#define b2_q7_q15_offset_ele(src,dst)													\
/* convert from q7 to q15 and then store the results in the destination buffer */	\
/*in_q7x4 = b2_nn_read_q7x4_ia((const int8_t **)&src);											 	\
in_q15x2_1 = SXTB16_RORn(in_q7x4, 8);										 	\
in_q15x2_2 = SXTB16(in_q7x4);		*/												 	\
...
out_q15x2_2 = SADD16(out_q15x2_2, offset_q15x2);									\
																					\
out_q15x2_1 = PKHBT(in_q15x2_2, in_q15x2_1, 16);									\
out_q15x2_1 = SADD16(out_q15x2_1, offset_q15x2);									\
																					\
write_s16x2_ia(&dst, out_q15x2_1);													\
write_s16x2_ia(&dst, out_q15x2_2);

#define b4_q7_q15_offset_ele(src,dst)													\
/* convert from q7 to q15 and then store the results in the destination buffer */	\
/*in_q7x4 = b4_nn_read_q7x4_ia((const int8_t **)&src);											 	\
in_q15x2_1 = SXTB16_RORn(in_q7x4, 8);										 	\
in_q15x2_2 = SXTB16(in_q7x4);		*/											 	\
...
/* convert from q7 to q15 and then store the results in the destination buffer */	\
in_q7x4 = arm_nn_read_s8x4_ia((const int8_t **)&src);									\
...
in_q7x4 = arm_nn_read_s8x4_ia((const q8_t **)&src);											 	\
...
\
/* Extract and sign extend each of the four q7 values to q15 */\
out_q15x2_1 = SXTB16_RORn(in_q7x4, 8);\
out_q15x2_2 = SXTB16(in_q7x4);\
\
out_q15x2_1 = SADD16(out_q15x2_1, offset_q15x2);\
out_q15x2_2 = SADD16(out_q15x2_2, offset_q15x2);\
\
...
dst = (int16_t*)dst_31;\
dst2 = (int16_t*)dst2_31;\
dst3 = (int16_t*)dst3_31;\
dst4 = (int16_t*)dst4_31;\
dst5 = (int16_t*)dst5_31;\
dst6 = (int16_t*)dst6_31;\
dst7 = (int16_t*)dst7_31;\

#define assignq15toq31()\
dst_31 = (int32_t*)dst;\
dst2_31 = (int32_t*)dst2;\
dst3_31 = (int32_t*)dst3;\
dst4_31 = (int32_t*)dst4;\
dst5_31 = (int32_t*)dst5;\
dst6_31 = (int32_t*)dst6;\
dst7_31 = (int32_t*)dst7;\
