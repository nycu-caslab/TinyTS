 ...
 *
 */
arm_cmsis_nn_status arm_nn_mat_mult_nt_t_s8_contribs(const int8_t *lhs,
                                            const int8_t *rhs,
                                            const int32_t *bias,
                                            int8_t *dst,
                                            const int32_t *dst_multipliers,
                                            ...
                                            const int32_t lhs_cols_offset)
{
    ...
    for (int32_t rhs_rows_idx = 0; rhs_rows_idx <= (rhs_rows - 2); rhs_rows_idx += 2)
    {
        ...
        int32_t lhs_offset_contribution0 = contribs[rhs_rows_idx];
        int32_t lhs_offset_contribution1 = contribs[rhs_rows_idx + 1];
