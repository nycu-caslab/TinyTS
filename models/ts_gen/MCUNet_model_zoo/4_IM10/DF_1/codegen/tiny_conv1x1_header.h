void conv_2d_tiny_1x1(int shared_param_idx, int output_split_id, int scratch_buffer_offset) {
  #if HIDE_CONV
    return;
  #endif
  ...
  // conv_2d_simd(params, &data, scratch_buffer_offset, combined_ifmap, filter_data, bias_data, output_data, output_height);
  {
    ...
    int16_t buf[output_depth * 2];

    arm_convolve_1x1_s8_tiny(combined_ifmap.inputs_data, input_width, input_height, input_depth, filter_data,
        ...
        output_data, output_width, output_height, output_depth, buf);
  }
}
