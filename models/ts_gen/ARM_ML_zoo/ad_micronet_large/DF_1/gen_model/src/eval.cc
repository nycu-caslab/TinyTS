...
void eval(int8_t *input_data){
    ...
    conv_2d(0, 1, 17696);
    conv_2d(0, 2, 26528);
    depthwise_conv_2d_tiny_kernel3x3_stride2(0, 0, 31040);
    conv_2d(1, 0, -1);
    conv_2d(0, 3, 8832);
    conv_2d(0, 4, 26496);
    depthwise_conv_2d_tiny_kernel3x3_stride2(0, 1, 31040);
    conv_2d(1, 1, -1);
    ...
    conv_2d(0, 7, 8832);
    conv_2d(0, 8, 39808);
    depthwise_conv_2d_tiny_kernel3x3_stride2(0, 3, 48192);
    conv_2d(1, 3, -1);
