...
void arm_convolve_1x1_s8_tiny(const int8_t * const *input, const uint16_t input_x,
  ...
  switch(input_ch){
    case 8:
      convolve_1x1_s8_ch8(*input, input_x, input_y, input_ch, kernel,
        bias, output_shift, output_mult, out_offset, input_offset,
        out_activation_min, out_activation_max, output,
        output_x, output_y, output_ch, runtime_buf);
      break;
    case 16:
      convolve_1x1_s8_ch16(*input, input_x, input_y, input_ch, kernel,
        bias, output_shift, output_mult, out_offset, input_offset,
        out_activation_min, out_activation_max, output,
        output_x, output_y, output_ch, runtime_buf);
      break;
    case 24:
      convolve_1x1_s8_ch24(*input, input_x, input_y, input_ch, kernel,
        bias, output_shift, output_mult, out_offset, input_offset,
        out_activation_min, out_activation_max, output,
        output_x, output_y, output_ch, runtime_buf);
      break;
    case 48:
      convolve_1x1_s8_ch48(*input, input_x, input_y, input_ch, kernel,
        bias, output_shift, output_mult, out_offset, input_offset,
        out_activation_min, out_activation_max, output,
        output_x, output_y, output_ch, runtime_buf);
      break;
    default:
      convolve_1x1_s8(*input, input_x, input_y, input_ch, kernel,
        bias, output_shift, output_mult, out_offset, input_offset,
        out_activation_min, out_activation_max, output,
        output_x, output_y, output_ch, runtime_buf);
  }
