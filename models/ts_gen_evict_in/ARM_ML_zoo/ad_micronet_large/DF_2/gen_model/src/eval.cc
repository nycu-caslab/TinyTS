...
void eval(int8_t *input_data){
    ...
    conv_2d(0, 1, 35328);
    conv_2d(0, 2, 52992);
    depthwise_conv_2d_tiny_kernel3x3_stride2(0, 0, 61824);
    conv_2d(1, 0, -1);
    conv_2d(0, 3, 17664);
    conv_2d(0, 4, 52992);
    depthwise_conv_2d_tiny_kernel3x3_stride2(0, 1, 61824);
    conv_2d(1, 1, -1);
    ...
    conv_2d(0, 7, 17664);
    conv_2d(0, 8, 79488);
    depthwise_conv_2d_tiny_kernel3x3_stride2(0, 3, 96256);
    conv_2d(1, 3, -1);
