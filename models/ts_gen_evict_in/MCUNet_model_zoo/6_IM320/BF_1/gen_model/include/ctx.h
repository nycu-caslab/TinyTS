...
#define MODEL_NAME "6_IM320_splitted_BF_1"
...
extern const int32_t split_offset[1750];
extern const uint8_t offline_tensor_data[756016];
int CtxSummary();
#endif
