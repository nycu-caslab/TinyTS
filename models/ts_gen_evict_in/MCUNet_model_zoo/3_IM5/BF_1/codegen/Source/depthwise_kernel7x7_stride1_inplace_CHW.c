...
static void depthwise_kernel7x7_stride1_inplace_kernel_CHW(
                ...
                const uint16_t output_ch, int16_t *runtime_buf, int8_t pad_value, int pad_h, int pad_w, uint16_t pad_yb)
{
    ...
    for (c = 0; c < input_ch; c++){
        ...
        depthwise_kernel7x7_stride1_inplace_kernel_CHW(output_y, output_x, bias++, offsetBias++, ksrc, output_mult++, output_shift++, inplace_out,output_offset,output_activation_min, output_activation_max,cols_8b_start, input_x_runtime_padded, input_ch, pad_h, pad_w);
        ksrc += 49;
