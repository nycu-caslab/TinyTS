...
#define MODEL_NAME "kws_MLPerf_splitted_DF_2"
...
extern const Tensor tensors[42];
...
extern const int32_t split_offset[142];
extern const uint8_t offline_tensor_data[24464];
int CtxSummary();
#endif
