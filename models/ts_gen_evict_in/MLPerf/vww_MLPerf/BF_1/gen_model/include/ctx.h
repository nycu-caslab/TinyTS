...
#define MODEL_NAME "vww_MLPerf_splitted_BF_1"
...
extern const Tensor tensors[95];
...
extern const int8_t quant_zeropoint[290];
extern const int32_t split_offset[468];
extern const uint8_t offline_tensor_data[219168];
int CtxSummary();
#endif
